...
def download_sentinel_2023():
    """Download Sentinel-2 imagery for Abu Dhabi in 2023 with matching parameters to 2018 image."""
    # Initialize GEE
    ...
    # Define scale
    scale = 30  # 30m scale for larger area coverage
    ...
    # Define time period (all of 2023)
    ...
    task = ee.batch.Export.image.toDrive(
        image=sentinel,
        description='sentinel2_abudhabi_2023',
        scale=scale,
        region=region,
        fileFormat='GeoTIFF',
        folder='EarthEngine',
        crs='EPSG:4326'  # Match CRS to 2018
    )
